...
<div class="wrapper col-lg-9">
		<h2>Estatísticas da violência no Estado de São Paulo</h2>
	
		<p>A cada três meses a Secreataria de Segurança Pública de São Paulo divulga os números relativos às ocorrências registradas em São Paulo. Este projeto pretende trabalhar estes números e divulgar de uma forma prática e assessível de forma que todo cidadão possa acompanhar a evolução das estatísticas e os reflexos dos trabalhos sociais em âmbito estadual e municipal.</p>
